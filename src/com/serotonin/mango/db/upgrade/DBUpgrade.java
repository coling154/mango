 ...
 * 'Upgrade[maj]_[min]_[mic]', where '[maj]_[min]_[mic]' is the version that the class upgrades from. The subclass must
 * be in this package.
 * 
 * @author Matthew Lohbihler
 */
abstract public class DBUpgrade extends BaseDao {
    ...
    public static void checkUpgrade() {
        ...
        while (true) {
            ...
            String upgradeClassname = DBUpgrade.class.getPackage().getName() + ".Upgrade"
