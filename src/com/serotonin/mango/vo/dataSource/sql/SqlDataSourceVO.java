...
public class SqlDataSourceVO extends DataSourceVO<SqlDataSourceVO> {
    ...
    protected void addEventTypes(List<EventTypeVO> ets) {
        ets.add(createEventType(SqlDataSourceRT.DATA_SOURCE_EXCEPTION_EVENT, new LocalizableMessage(
                "event.ds.dataSource")));
        ets
                .add(createEventType(SqlDataSourceRT.STATEMENT_EXCEPTION_EVENT, new LocalizableMessage(
                        "event.ds.statement")));
    }

    private static final ExportCodes EVENT_CODES = new ExportCodes();
    static {
        EVENT_CODES.addElement(SqlDataSourceRT.DATA_SOURCE_EXCEPTION_EVENT, "DATA_SOURCE_EXCEPTION");
        EVENT_CODES.addElement(SqlDataSourceRT.STATEMENT_EXCEPTION_EVENT, "STATEMENT_EXCEPTION");
    }
    ...
    public void validate(DwrResponseI18n response) {
        ...
        if (StringUtils.isEmpty(driverClassname))
            response.addContextualMessage("driverClassname", "validate.required");
    ...
    @Override
    protected void addPropertyChangesImpl(List<LocalizableMessage> list, SqlDataSourceVO from) {
